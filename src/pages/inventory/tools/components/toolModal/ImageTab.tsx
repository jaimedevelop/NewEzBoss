// src/pages/inventory/tools/components/toolModal/ImageTab.tsx
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="text-sm text-blue-800">
            ...
            <ol className="list-decimal list-inside space-y-1">
              <li>Find an image of your tool online (manufacturer website, Amazon, etc.)</li>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
          <li>Manufacturer websites (DeWalt, Milwaukee, Makita, etc.)</li>
          <li>Amazon product pages</li>
          <li>Home Depot or Lowe's product listings</li>
          <li>Tool retailer websites</li>
        </ul>
      </div>
    </div>
  );
