...
import { findEmptyCategories, type EmptyCategoriesResult, type EmptyCategoryItem, type ScanProgress } from '../../../../services/categories';
...
const EmptyChecker: React.FC<EmptyCheckerProps> = ({ isOpen, onClose, onBack }) => {
  ...
  const loadEmptyCategories = async () => {
    ...
    try {
      const result = await findEmptyCategories(currentUser.uid, (prog) => {
        setProgress(prog);
      });
