...
import { Eye, EyeOff, Calendar, DollarSign, Filter } from 'lucide-react';
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex items-center gap-6">
            ...
            <button
                ...
                className={`flex items-center gap-3 px-4 py-2 rounded-xl transition-all ${showEvents
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    <div className={`w-2 h-2 rounded-full ${showEvents ? 'bg-blue-500' : 'bg-gray-300'}`}></div>
